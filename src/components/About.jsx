        ...
        <section className="white-section" id="about">
            <div className='container-fluid'>
                ...
                <p className="text-justify">
                    ...
                    logical validation models for real-time systems.<br />
                    My experience includes working as a software engineer at ECR and lecturing in
                    the Department of Computer Science. I'm passionate about emerging tech, research,
                    and translating complex ideas into meaningful digital solutions.
                </p>
            </div>
        </section >
    );
